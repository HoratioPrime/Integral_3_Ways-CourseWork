...
public:
    ...
    {
        AvatarSettingsForm->setWindowTitle(QCoreApplication::translate("AvatarSettingsForm", "Form", nullptr));
        useThemeColorsLabel->setText(QCoreApplication::translate("AvatarSettingsForm", "Use theme colors", nullptr));
        textColorLabel->setText(QCoreApplication::translate("AvatarSettingsForm", "Text color", nullptr));
        textColorToolButton->setText(QCoreApplication::translate("AvatarSettingsForm", "...", nullptr));
        backgroundColorLabel->setText(QCoreApplication::translate("AvatarSettingsForm", "Background color", nullptr));
        backgroundColorToolButton->setText(QCoreApplication::translate("AvatarSettingsForm", "...", nullptr));
        sizeLabel->setText(QCoreApplication::translate("AvatarSettingsForm", "Size", nullptr));
        typeLabel->setText(QCoreApplication::translate("AvatarSettingsForm", "Type", nullptr));
        typeComboBox->setItemText(0, QCoreApplication::translate("AvatarSettingsForm", "Letter", nullptr));
        typeComboBox->setItemText(1, QCoreApplication::translate("AvatarSettingsForm", "Image", nullptr));
        typeComboBox->setItemText(2, QCoreApplication::translate("AvatarSettingsForm", "Icon", nullptr));

        disabledLabel->setText(QCoreApplication::translate("AvatarSettingsForm", "Disabled", nullptr));
    } // retranslateUi
