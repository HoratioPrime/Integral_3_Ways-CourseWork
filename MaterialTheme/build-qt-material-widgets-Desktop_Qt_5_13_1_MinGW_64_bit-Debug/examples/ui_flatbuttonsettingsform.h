...
public:
    ...
    {
        FlatButtonSettingsForm->setWindowTitle(QCoreApplication::translate("FlatButtonSettingsForm", "Form", nullptr));
        disabledCheckBox->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Disabled", nullptr));
        checkableCheckBox->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Checkable", nullptr));
        checkedCheckBox->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Checked", nullptr));
        showHaloCheckBox->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Show halo", nullptr));
        transparentCheckBox->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Transparent", nullptr));
        iconCheckBox->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Icon", nullptr));
        buttonRoleLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Button role", nullptr));
        buttonRoleComboBox->setItemText(0, QCoreApplication::translate("FlatButtonSettingsForm", "Default", nullptr));
        buttonRoleComboBox->setItemText(1, QCoreApplication::translate("FlatButtonSettingsForm", "Primary", nullptr));
        buttonRoleComboBox->setItemText(2, QCoreApplication::translate("FlatButtonSettingsForm", "Secondary", nullptr));

        rippleStyleLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Ripple style", nullptr));
        rippleStyleComboBox->setItemText(0, QCoreApplication::translate("FlatButtonSettingsForm", "Centered", nullptr));
        rippleStyleComboBox->setItemText(1, QCoreApplication::translate("FlatButtonSettingsForm", "Positioned", nullptr));
        rippleStyleComboBox->setItemText(2, QCoreApplication::translate("FlatButtonSettingsForm", "No Ripple", nullptr));

        hoverStyleLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Hover style", nullptr));
        hoverStyleComboBox->setItemText(0, QCoreApplication::translate("FlatButtonSettingsForm", "No Overlay", nullptr));
        hoverStyleComboBox->setItemText(1, QCoreApplication::translate("FlatButtonSettingsForm", "Tinted Overlay", nullptr));
        hoverStyleComboBox->setItemText(2, QCoreApplication::translate("FlatButtonSettingsForm", "Gray Overlay", nullptr));

        iconPlacementLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Icon placement", nullptr));
        iconPlacementComboBox->setItemText(0, QCoreApplication::translate("FlatButtonSettingsForm", "Left", nullptr));
        iconPlacementComboBox->setItemText(1, QCoreApplication::translate("FlatButtonSettingsForm", "Right", nullptr));

        cornerRadiusLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Corner radius", nullptr));
        overlayOpacityLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Overlay opacity", nullptr));
        iconSizeLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Icon size", nullptr));
        fontSizeLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Font size", nullptr));
        buttonTextLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Button text", nullptr));
        textAlignmentLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Text alignment", nullptr));
        textAlignmentComboBox->setItemText(0, QCoreApplication::translate("FlatButtonSettingsForm", "Left", nullptr));
        textAlignmentComboBox->setItemText(1, QCoreApplication::translate("FlatButtonSettingsForm", "Center", nullptr));

        useThemeColorsCheckBox->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Use theme colors", nullptr));
        backgroundColorLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Background color", nullptr));
        backgroundColorToolButton->setText(QCoreApplication::translate("FlatButtonSettingsForm", "...", nullptr));
        foregroundColorLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Foreground color", nullptr));
        foregroundColorToolButton->setText(QCoreApplication::translate("FlatButtonSettingsForm", "...", nullptr));
        disabledBgColorLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Disabled bg color", nullptr));
        disabledFgColorLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Disabled fg color", nullptr));
        overlayColorLabel->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Overlay color", nullptr));
        overlayColorToolButton->setText(QCoreApplication::translate("FlatButtonSettingsForm", "...", nullptr));
        disabledBgColorToolButton->setText(QCoreApplication::translate("FlatButtonSettingsForm", "...", nullptr));
        disabledFgColorToolButton->setText(QCoreApplication::translate("FlatButtonSettingsForm", "...", nullptr));
        defaultPresetPushButton->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Apply default preset", nullptr));
        checkablePresetPushButton->setText(QCoreApplication::translate("FlatButtonSettingsForm", "Apply checkable preset", nullptr));
    } // retranslateUi
