...
public:
    ...
    {
        CheckBoxSettingsForm->setWindowTitle(QCoreApplication::translate("CheckBoxSettingsForm", "Form", nullptr));
        disabledLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Disabled", nullptr));
        labelPositionLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Label position", nullptr));
        labelPositionComboBox->setItemText(0, QCoreApplication::translate("CheckBoxSettingsForm", "Left", nullptr));
        labelPositionComboBox->setItemText(1, QCoreApplication::translate("CheckBoxSettingsForm", "Right", nullptr));

        labelTextLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Label text", nullptr));
        checkedLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Checked", nullptr));
        useThemeColorsLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Use theme colors", nullptr));
        checkedColorLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Checked color", nullptr));
        checkedColorToolButton->setText(QCoreApplication::translate("CheckBoxSettingsForm", "...", nullptr));
        uncheckedColorLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Unchecked color", nullptr));
        uncheckedColorToolButton->setText(QCoreApplication::translate("CheckBoxSettingsForm", "...", nullptr));
        textColorLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Text color", nullptr));
        disabledColorLabel->setText(QCoreApplication::translate("CheckBoxSettingsForm", "Disabled color", nullptr));
        textColorToolButton->setText(QCoreApplication::translate("CheckBoxSettingsForm", "...", nullptr));
        disabledColorToolButton->setText(QCoreApplication::translate("CheckBoxSettingsForm", "...", nullptr));
    } // retranslateUi
