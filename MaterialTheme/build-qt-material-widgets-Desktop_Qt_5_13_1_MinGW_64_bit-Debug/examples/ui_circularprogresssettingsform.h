...
public:
    ...
    {
        CircularProgressSettingsForm->setWindowTitle(QCoreApplication::translate("CircularProgressSettingsForm", "Form", nullptr));
        disabledLabel->setText(QCoreApplication::translate("CircularProgressSettingsForm", "Disabled", nullptr));
        progressTypeLabel->setText(QCoreApplication::translate("CircularProgressSettingsForm", "Progress type", nullptr));
        progressTypeComboBox->setItemText(0, QCoreApplication::translate("CircularProgressSettingsForm", "Determinate", nullptr));
        progressTypeComboBox->setItemText(1, QCoreApplication::translate("CircularProgressSettingsForm", "Indeterminate", nullptr));

        lineWidthLabel->setText(QCoreApplication::translate("CircularProgressSettingsForm", "Line width", nullptr));
        sizeLabel->setText(QCoreApplication::translate("CircularProgressSettingsForm", "Size", nullptr));
        useThemeColorsLabel->setText(QCoreApplication::translate("CircularProgressSettingsForm", "Use theme colors", nullptr));
        colorLabel->setText(QCoreApplication::translate("CircularProgressSettingsForm", "Color", nullptr));
        colorToolButton->setText(QCoreApplication::translate("CircularProgressSettingsForm", "...", nullptr));
        progressLabel->setText(QCoreApplication::translate("CircularProgressSettingsForm", "Progress", nullptr));
    } // retranslateUi
