...
public:
    ...
    {
        SliderSettingsForm->setWindowTitle(QCoreApplication::translate("SliderSettingsForm", "Form", nullptr));
        disabledLabel->setText(QCoreApplication::translate("SliderSettingsForm", "Disabled", nullptr));
        valueLabel->setText(QCoreApplication::translate("SliderSettingsForm", "Value", nullptr));
        orientationLabel->setText(QCoreApplication::translate("SliderSettingsForm", "Orientation", nullptr));
        orientationComboBox->setItemText(0, QCoreApplication::translate("SliderSettingsForm", "Horizontal", nullptr));
        orientationComboBox->setItemText(1, QCoreApplication::translate("SliderSettingsForm", "Vertical", nullptr));

        invertedLabel->setText(QCoreApplication::translate("SliderSettingsForm", "Inverted", nullptr));
        label->setText(QCoreApplication::translate("SliderSettingsForm", "TODO", nullptr));
    } // retranslateUi
