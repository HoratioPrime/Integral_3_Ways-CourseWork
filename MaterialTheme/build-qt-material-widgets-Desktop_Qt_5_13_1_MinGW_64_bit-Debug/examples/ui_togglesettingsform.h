...
public:
    ...
    {
        ToggleSettingsForm->setWindowTitle(QCoreApplication::translate("ToggleSettingsForm", "Form", nullptr));
        disabledLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Disabled", nullptr));
        checkedLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Checked", nullptr));
        orientationLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Orientation", nullptr));
        orientationComboBox->setItemText(0, QCoreApplication::translate("ToggleSettingsForm", "Horizontal", nullptr));
        orientationComboBox->setItemText(1, QCoreApplication::translate("ToggleSettingsForm", "Vertical", nullptr));

        activeColorLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Active color", nullptr));
        inactiveColorLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Inactive color", nullptr));
        disabledColorLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Disabled color", nullptr));
        trackColorLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Track color", nullptr));
        activeColorToolButton->setText(QCoreApplication::translate("ToggleSettingsForm", "...", nullptr));
        inactiveColorToolButton->setText(QCoreApplication::translate("ToggleSettingsForm", "...", nullptr));
        disabledColorToolButton->setText(QCoreApplication::translate("ToggleSettingsForm", "...", nullptr));
        trackColorToolButton->setText(QCoreApplication::translate("ToggleSettingsForm", "...", nullptr));
        useThemeColorsLabel->setText(QCoreApplication::translate("ToggleSettingsForm", "Use theme colors", nullptr));
    } // retranslateUi
