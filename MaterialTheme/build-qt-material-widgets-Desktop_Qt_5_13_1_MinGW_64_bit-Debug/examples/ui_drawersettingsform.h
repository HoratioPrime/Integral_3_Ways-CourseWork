...
public:
    ...
    {
        DrawerSettingsForm->setWindowTitle(QCoreApplication::translate("DrawerSettingsForm", "Form", nullptr));
        overlayModeLabel->setText(QCoreApplication::translate("DrawerSettingsForm", "Overlay mode", nullptr));
        clickToCloseLabel->setText(QCoreApplication::translate("DrawerSettingsForm", "Click to close", nullptr));
        showDrawerButton->setText(QCoreApplication::translate("DrawerSettingsForm", "Show drawer", nullptr));
        hideDrawerButton->setText(QCoreApplication::translate("DrawerSettingsForm", "Hide drawer", nullptr));
    } // retranslateUi
