...
public:
    ...
    {
        ProgressSettingsForm->setWindowTitle(QCoreApplication::translate("ProgressSettingsForm", "Form", nullptr));
        disabledLabel->setText(QCoreApplication::translate("ProgressSettingsForm", "Disabled", nullptr));
        progressTypeLabel->setText(QCoreApplication::translate("ProgressSettingsForm", "Progress type", nullptr));
        progressTypeComboBox->setItemText(0, QCoreApplication::translate("ProgressSettingsForm", "Determinate", nullptr));
        progressTypeComboBox->setItemText(1, QCoreApplication::translate("ProgressSettingsForm", "Indeterminate", nullptr));

        progressLabel->setText(QCoreApplication::translate("ProgressSettingsForm", "Progress", nullptr));
        useThemeColorsLabel->setText(QCoreApplication::translate("ProgressSettingsForm", "Use theme colors", nullptr));
        colorLabel->setText(QCoreApplication::translate("ProgressSettingsForm", "Progress color", nullptr));
        progressColorToolButton->setText(QCoreApplication::translate("ProgressSettingsForm", "...", nullptr));
        backgroundColorLabel->setText(QCoreApplication::translate("ProgressSettingsForm", "Background color", nullptr));
        backgroundColorToolButton->setText(QCoreApplication::translate("ProgressSettingsForm", "...", nullptr));
    } // retranslateUi
