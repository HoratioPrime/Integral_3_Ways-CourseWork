...
public:
    ...
    {
        RadioButtonSettingsForm->setWindowTitle(QCoreApplication::translate("RadioButtonSettingsForm", "Form", nullptr));
        disabledLabel->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Disabled", nullptr));
        labelTextLabel_2->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Label text", nullptr));
        useThemeColorsLabel_3->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Use theme colors", nullptr));
        checkedColorLabel_3->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Checked color", nullptr));
        uncheckedColorLabel_3->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Unchecked color", nullptr));
        textColorLabel_3->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Text color", nullptr));
        disabledColorLabel_3->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Disabled color", nullptr));
        labelPositionLabel_3->setText(QCoreApplication::translate("RadioButtonSettingsForm", "Label position", nullptr));
        labelPositionComboBox_2->setItemText(0, QCoreApplication::translate("RadioButtonSettingsForm", "Left", nullptr));
        labelPositionComboBox_2->setItemText(1, QCoreApplication::translate("RadioButtonSettingsForm", "Right", nullptr));

        checkedColorToolButton_2->setText(QCoreApplication::translate("RadioButtonSettingsForm", "...", nullptr));
        uncheckedColorToolButton_2->setText(QCoreApplication::translate("RadioButtonSettingsForm", "...", nullptr));
        textColorToolButton_2->setText(QCoreApplication::translate("RadioButtonSettingsForm", "...", nullptr));
        disabledColorToolButton_2->setText(QCoreApplication::translate("RadioButtonSettingsForm", "...", nullptr));
    } // retranslateUi
