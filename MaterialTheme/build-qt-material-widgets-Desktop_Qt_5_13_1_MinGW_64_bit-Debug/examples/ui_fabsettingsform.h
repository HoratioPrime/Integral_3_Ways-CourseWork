...
public:
    ...
    {
        FloatingActionButtonSettingsForm->setWindowTitle(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Form", nullptr));
        disabledLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Disabled", nullptr));
        cornerLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Corner", nullptr));
        cornerComboBox->setItemText(0, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Top Left", nullptr));
        cornerComboBox->setItemText(1, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Top Right", nullptr));
        cornerComboBox->setItemText(2, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Bottom Left", nullptr));
        cornerComboBox->setItemText(3, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Bottom Right", nullptr));

        buttonRoleLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Button role", nullptr));
        buttonRoleComboBox->setItemText(0, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Default", nullptr));
        buttonRoleComboBox->setItemText(1, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Primary", nullptr));
        buttonRoleComboBox->setItemText(2, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Secondary", nullptr));

        horizontalOffsetLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Horizontal offset", nullptr));
        verticalOffsetLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Vertical offset", nullptr));
        miniLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Mini", nullptr));
        rippleStyleLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Ripple style", nullptr));
        rippleStyleComboBox->setItemText(0, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Centered", nullptr));
        rippleStyleComboBox->setItemText(1, QCoreApplication::translate("FloatingActionButtonSettingsForm", "Positioned", nullptr));
        rippleStyleComboBox->setItemText(2, QCoreApplication::translate("FloatingActionButtonSettingsForm", "No Ripple", nullptr));

        useThemeColorsLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Use theme colors", nullptr));
        backgroundColorLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Background color", nullptr));
        backgroundColorToolButton->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "...", nullptr));
        foregroundColorLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Foreground color", nullptr));
        disabledBgColorLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Disabled bg color", nullptr));
        disabledFgColorLabel->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "Disabled fg color", nullptr));
        foregroundColorToolButton->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "...", nullptr));
        disabledBgColorToolButton->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "...", nullptr));
        disabledFgColorToolButton->setText(QCoreApplication::translate("FloatingActionButtonSettingsForm", "...", nullptr));
    } // retranslateUi
